...
def pivot_months_pandas(data):
    ...
    monthly = new_frame1.pivot(index=data['name'],columns=data['month'],values=data['precipitation'])
    counts = new_frame2.pivot(index=data['name'],columns=data['month'],values=data['precipitation'])
