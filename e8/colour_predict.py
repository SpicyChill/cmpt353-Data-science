...
def main():
    ...
    knn_rgb_model = KNeighborsClassifier(5)
    knn_convert_model = make_pipeline(
         FunctionTransformer(covert_rgb),
         KNeighborsClassifier(5)
    )
    rf_rgb_model = RandomForestClassifier(n_estimators = 50, max_depth = 11, min_samples_leaf = 15 )
    rf_convert_model = make_pipeline(
         FunctionTransformer(covert_rgb),
         RandomForestClassifier(n_estimators = 50, max_depth = 11, min_samples_leaf = 15 )
    )
